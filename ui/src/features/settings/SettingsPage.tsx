...
export function SettingsPage() {
  ...
  return <section className="feature-page settings-page">
    ...
    <section className="feature-card about-card"><h2>Chronolume 2.1.5</h2><p>{t('Chronolume 照亮本机 Codex 活动中的 Token、成本与时间脉络。应用不会读取 auth.json、在线配额或对话正文；价格更新是唯一可选网络能力，且只在用户明确触发后执行。')}</p></section>
  </section>;
}
